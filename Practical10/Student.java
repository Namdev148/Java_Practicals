...
public class Student {
    ...
    public static void main(String[] args) {
        ...
        student.setInfo("Name=Namdev Yevtikar ,Branch=IT,BloodGroup=O+,AdmissionYear=2024,Mode=DSY #Name=Vishal Barde,Branch=CSE,BloodGroup=O+,AdmissionYear=2023,Mode=Regular #Name=Om Bhosale,Branch=Mech,BloodGroup=A+,AdmissionYear=2023,Mode=Regular");
        for (Student s : array) {
            if (s != null) {
                s.displayInfo();
                System.out.println();
